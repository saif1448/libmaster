...
public:
    ...
    void saveWithoutHeader(const string &inputBinPath, const string &outputBinPath);
    ...
    // Save frames to a bin file without the header
    void saveToBinWithoutHeader(const string &outputBinPath);
};
